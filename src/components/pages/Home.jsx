...
const Home = () => {
  ...
  return (
    <>
      <div className="w-full flex flex-col gap-9 max-sm:w-[650px] md:w-[1200px]  xl:w-[100%] ">
        <Headers />
        <div>
          <img src={imageBg} alt="bg-img" />
        </div>
        <section className="flex  flex-wrap gap-2 m-auto w-[1140px] max-sm:w-[650px] lg:px-1  ">
